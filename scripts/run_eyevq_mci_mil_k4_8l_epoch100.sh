...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/eyevq/downstream_mci_subject_mil_concat4cls_h32_k4_8l_lr1e5_epoch100_spg4_pat10_rawauc_es_seed42_valid_eye_mintask4_noclassquota}"
